...
public class Dray : MonoBehaviour, IFacingMover, IKeyMaster
{
    ...
    public float transitionDone = 0;
    public Vector2 transitionPos;
    public bool hasGrappler = false;
    public bool hasSuperSword = false;
...
private KeyCode[] keys = new KeyCode[] { KeyCode.D, KeyCode.W, KeyCode.A, KeyCode.S };
    ...
    void Awake()
    {
        tDop = GetComponent<Dop>();
        sRend = GetComponent<SpriteRenderer>();
        rigid = GetComponent<Rigidbody>();
        anim = GetComponent<Animator>();
        inrRm = GetComponent<InRoom>();
        health = maxHealth;
    ...
    {
        return inrRm.GetRoomPosOnGrid(mult);
    }
    public int keyCount{
        get { return numKeys; }
        set { numKeys = value; }
    ...
    void Update()
    {
        ...
        if (invincible && Time.time > invicibleDone) invincible = false;
        ...
        if (Input.GetKeyDown(KeyCode.F) && Time.time >= timeAtkNext)
        {
            mode = eMode.attack;
    ...
    void OnTriggerEnter(Collider colld)
    {
        ...
        switch (pup.itemType)
        {
            ...
            case PickUp.eType.grappler:
                hasGrappler = true;
                break;
            case PickUp.eType.superSword:
                hasSuperSword = true;
                print("Yes, SuperSword!");
                break;
        }
